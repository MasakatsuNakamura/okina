...
第4問<BR>
<HR>
「文字の成り立ち字源」に関する説明文の中から間違っているものを一つ選んで下さい。</P>
<P><FORM ACTION="$cgipath/test5.cgi" METHOD=POST>
   <P><INPUT TYPE=radio NAME=ans VALUE=1 CHECKED>さんずいへんは<IMG SRC="$root/p19-2.gif" WIDTH=47 HEIGHT=45 ALIGN=bottom>の意味で4画に取る。酒は普通10画ですが11画に取る。<BR>
   <INPUT TYPE=radio NAME=ans VALUE=2>ころもへんは<IMG SRC="$root/p19-12.gif" WIDTH=47 HEIGHT=46 ALIGN=bottom>の意味で6画に取る。裕は12画に取り易いですが13画です。<BR>
   <INPUT TYPE=radio NAME=ans VALUE=3>くさかんむりは<IMG SRC="$root/p20-8.gif" WIDTH=47 HEIGHT=47 ALIGN=bottom>の意味で6画に取る。敬はくさかんむりにあらず普通の13画です。<BR>
