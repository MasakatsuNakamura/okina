...
class Seimei {
	...
	function kakusu ($sei, $mei) {
		...
		# 人画の算出
		$this->jinkaku = $this->kakusu(mb_substr($sei, mb_strlen($sei)-1, 1)) + $this->kakusu(mb_substr(mei1, 0, 1));
		...
		$tenshimo = $this->tenkaku % 10;
		$jinshimo = $this->jinkaku % 10;
