...
<P>
<HR>
<A HREF="$root/i-mode2.shtml" accesskey=1>1→もう一度鑑定する。</A><BR>
...
<P><FORM ACTION="$cgipath" METHOD=GET>
<INPUT TYPE="hidden" NAME="U" VALUE="$baseurl/cgi_bin2/i2seimei.cgi">
...
<P>
<HR>
<A HREF="$root/i-mode2.shtml" accesskey=1>1→鑑定をやり直す。</A><BR>
</P>
</BODY>
</HTML>
EOM
