...
?>
		...
		<div data-role="content">
		<h2><?php echo $seimei->sei . " " . $seimei->mei ?>さんの運勢 <div class="fb-share-button" data-href="http://okina.herokuapp.com/?sei=<?php echo urlencode($seimei->sei) . "&mei=" . urlencode($seimei->mei) . "&sex=" . $seimei->sex . "&marry=" . $seimei->marry ?>" data-type="button_count"></div></h1>
			<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
			<!-- 山本翁 -->
			<ins class="adsbygoogle"
			     style="display:inline-block;width:320px;height:100px"
