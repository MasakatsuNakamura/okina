...
<FONT COLOR="#0000FF"><U>おおまかな性格</U>
；当人の外面的な性格を現します。自分が他人からどう見えているのか参考になります。</FONT></P>

<P>$res{'seikaku'}</P>

<P><FORM ACTION="$cgipath/j5seimei.cgi" METHOD=GET>
   ...
   <INPUT TYPE=submit NAME="送信" VALUE="基礎運へ"><BR>
