...
<FONT COLOR="#FF0099"><U>基礎運</U>
；幼少年期の運勢の吉凶を支配し、青年期まで最も強く作用します。(若年者の判断はこちらが有効)</FONT></P>

<P>$kakusu{'chikaku'}画：$res{'chikaku'}</P>

<P><FORM ACTION="$cgipath/j6seimei.cgi" METHOD=GET>
   ...
   <INPUT TYPE=submit NAME="送信" VALUE="晩年運へ"><BR>
