...
if ($sei eq "" || $mei eq "") {
	print "Location: $baseurl$root/j-sky2.shtml\n\n";
	exit;
}
...
<P><FORM ACTION="$cgipath/j-n_mail.cgi" METHOD=GET>
   ...
   メールアドレス：<INPUT TYPE=text NAME=email2 VALUE="" MODE=alphabet SIZE=16 MAXLENGTH=256><BR>
...
<A HREF="$root/j-sky2.shtml" DIRECTKEY="1">1→もう一度鑑定する。</A><BR>
<A HREF="$root/j-info.html" DIRECTKEY="3">3→翁からのお知らせを読む。</A><BR>
</P>
</BODY>
</HTML>
EOK
...
<FONT COLOR="#FF0000"><U>主運</U>
；当人の一生の中心を司ります。結婚により姓が変わると主運も変わりますが、その場合は中年以降に強く現れます。まだお若い方は旧姓で入力してみて下さい。</FONT></P>

<P>$kakusu{'jinkaku'}画：$res{'jinkaku'}</P>

<P><FORM ACTION="$cgipath/j2seimei.cgi" METHOD=GET>
   ...
   <INPUT TYPE=submit NAME="送信" VALUE="対人・社交運へ"><BR>

</FORM>

<HR>

<A HREF="$root/j-sky2.shtml" DIRECTKEY="1">1→鑑定をやり直す。</A><BR>
</P>
</BODY>
</HTML>
EOM
